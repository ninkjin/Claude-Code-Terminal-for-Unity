...
If `git commit` reports `Author identity unknown`, configure your Git identity first:
...
After pushing, you can install the package in Unity Package Manager with the GitHub URL.
